      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            <div className="glass rounded-3xl p-8 md:p-10">
              <div className="flex items-center gap-6 mb-8">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-700 to-blue-900 flex items-center justify-center text-3xl font-bold text-white shadow-lg shadow-blue-950/60">
                  UD
                </div>
                <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {profile.info.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-blue-950/50 border border-blue-900/30 flex items-center justify-center text-blue-400 flex-shrink-0">
          ...
          >
            ...
            >
              <Sparkles className="absolute -inset-4" density={24} color="rgba(59,130,246,0.45)" />
              ...
              <div className="flex flex-wrap gap-3 relative z-10">
                {profile.tech.map((tech) => (
                  <span
                    key={tech}
                    className="px-4 py-2 rounded-full bg-blue-950/30 border border-blue-900/40 text-sm font-medium text-slate-300 hover:bg-blue-900/30 hover:border-blue-700/50 transition-all cursor-default"
                  >
                    {tech}
                  </span>
                ))}
