  ...
  return (
    <section className="relative py-24 md:py-32 px-6">
      <div className="max-w-4xl mx-auto">
        <Reveal>
          <div className="glass rounded-4xl p-10 md:p-14 text-center">
            ...
            <p className="text-slate-300 leading-relaxed mb-10 text-lg relative z-10">
              Have a project in mind or just want to say hi? I'm always open to discussing new opportunities, creative ideas, or potential collaborations.
            </p>
