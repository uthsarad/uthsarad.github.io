        ...
        <Reveal>
          <FadeContent blur={false} duration={1200} threshold={0.2}>
            <div className="glass rounded-4xl p-10 md:p-14 text-center relative overflow-hidden">
              ...
              <p className="text-slate-300 leading-relaxed mb-10 text-lg relative z-10 max-w-2xl mx-auto">
                Have a project in mind, an opportunity to discuss, or just want to connect? I'm always open to discussing new opportunities, creative ideas, or potential collaborations.
              </p>
